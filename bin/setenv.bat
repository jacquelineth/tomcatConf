...
echo off
set CATALINA_HOME=C:\DevTools\apache-tomcat-9.0.37
set JAVA_HOME=C:\jdk8_211
set ODM_HOME=C:\IBM\ODM8102
...
set JAVA_OPTS= -server -Xms1024m -Xmx4096m -Dfile.encoding=UTF-8 -Dteamserver.home.tomcat=%teamserver.home.tomcat% -Dexecutionserver.home.tomcat=%executionserver.home.tomcat%	-Dcom.sun.management.jmxremote.password.file=%CATALINA_BASE%\conf\jmxremote.password -Dcom.sun.management.jmxremote.access.file=%CATALINA_BASE%\conf\jmxremote.access -Dcom.sun.management.jmxremote.ssl=false %RTS_OPTS%
